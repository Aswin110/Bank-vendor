...
function Update() {
    ...
    useEffect(() => {
        async function vendorFunc () {
            try{
                const res = await axios.get(`${apiUrl}vendor/${id}/update`)
    ...
    const notify = () => toast.success('vendor updated successfully', {
        position: "top-center",
        autoClose: 1000,
            ...
            <div className='m-auto flex flex-col items-center'>
                ...
                {loading ?
                    ...
                    :(
                        ...
                        <form action="/vendor/:id/update" method='POST' onSubmit={updateVendor} className='flex flex-col gap-4'>
